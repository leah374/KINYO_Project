...
TRANSCRIPTS_CSV = PROJECT_ROOT / "transcription_result" / "transcripts.csv"
KB_DIR = PROJECT_ROOT / "previous_knowledge_base"
PROCESSED_KB_DIR = PROJECT_ROOT / "rag_knowledge_base"
EVALUATION_STANDARD_PATH = next(KB_DIR.glob("*v4.json"), KB_DIR / "内容评价标准库_v4.json")
LOCAL_VECTOR_DIR = PROJECT_ROOT / "vector_db" / "local_vector_fallback"
FAISS_VECTOR_DIR = PROJECT_ROOT / "vector_db"
